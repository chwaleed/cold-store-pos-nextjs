...
INSERT INTO "new_Ledger" ("clearanceReceiptId", "createdAt", "creditAmount", "customerId", "debitAmount", "description", "discount", "entryReceiptId", "id", "type", "updatedAt") SELECT "clearanceReceiptId", "createdAt", "creditAmount", "customerId", "debitAmount", "description", "discount", "entryReceiptId", "id", "type", "updatedAt" FROM "Ledger";
DROP TABLE "Ledger";
